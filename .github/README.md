...
[`@aws-sdk/client-geo-routes`](https://www.npmjs.com/package/@aws-sdk/client-geo-routes/v/3.1117.0).
...
- @aws-sdk/client-geo-routes v3.1117.0 - [https://cloud-sdk-builds.github.io/?sdk=client-geo-routes&version=3.1117.0](https://cloud-sdk-builds.github.io/?sdk=client-geo-routes&version=3.1117.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-geo-routes@3.1117.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gaVBkxLQBVbIt+WOr2yvUYCpNgr7+yhzUyMXNgRlGpG8+M+WR6v4bCPI9vCT+qaQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-geo-routes": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-geo-routes@3.1117.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-geo-routes@3.1117.0/index.min.mjs": "sha384-gaVBkxLQBVbIt+WOr2yvUYCpNgr7+yhzUyMXNgRlGpG8+M+WR6v4bCPI9vCT+qaQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-geo-routes/blob/refs/tags/3.1117.0/LICENSE
```
